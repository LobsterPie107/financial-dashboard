# trial01 - Baseline Dashboard Template

> This is the clean baseline from the complete rebuild on 2026-06-27.
> If told "go back to trial01", restore index.html from this file.

## File Location
- Saved from: `financial-dashboard/index.html`
- Commit: `14cc85b` (clean rebuild from specs)
- Deployed at: `https://lobsterpie107.github.io/financial-dashboard/?v=2`

## Current live commit
`c72ad48` — heading changed to "About the Dollar Dominance trend", stock news as bullet points

## How to Restore baseline (trial01)
Copy the entire `<html>` block below into `financial-dashboard/index.html`, commit, and push.
