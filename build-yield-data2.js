...
https.get(url, {headers:{'User-Agent':'Mozilla/5.0'}}, function(res) {
  ...
  res.on('end', () => {
    ...
    fs.writeFileSync('C:/Users/OpenClaw/.openclaw/workspace/financial-dashboard/data/yield-curve.json', JSON.stringify(result), 'utf8');
    console.log('Saved. Points:', history.length, 'Latest:', result.latestDate);
  });
});
